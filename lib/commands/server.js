...
(function() {
  var compiler, connect, fs, host_rule, http, http_proxy, https, listenPort, middleware, server_weinre, setupProxyServer, setupServer, utils;
  ...
  exports.set_options = function(optimist) {
    ...
    return optimist.describe('i', '启动weinre');
  };
  ...
  exports.run = function(options) {
    ...
    if (options.weinre) {
      return server_weinre.run(options, function(opt) {
        return utils.logger.log('weinre 已启动，请访问http://' + opt.boundHost + ':' + opt.httpPort);
      });
    }
  };
